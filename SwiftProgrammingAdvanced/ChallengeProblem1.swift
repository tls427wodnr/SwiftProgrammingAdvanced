...
class HybridCar: Car {
    override init(brand: String, model: String, modelYear: Int, engine: Engine) {
        super.init(brand: brand, model: model, modelYear: modelYear, engine: engine)
    }

    convenience init(brand: String, model: String, modelYear: Int) {
        self.init(brand: brand, model: model, modelYear: modelYear, engine: Engine(type: .hydrogen))
    }
...
//  var hybridCar = HybridCar(brand: "Kia", model: "str-2020", modelYear: 2020, engine: Engine(type: EngineType.hydrogen))
    let hybridCar = HybridCar(brand: "Kia", model: "str-2020", modelYear: 2020)
